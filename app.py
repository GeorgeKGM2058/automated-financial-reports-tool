...
st.markdown("[Run the full notebook (one click)](https://colab.research.google.com/github/GeorgeKGM2058/automated-financial-reports-tool/blob/main/financial_analysis_tool.ipynb)")
